...
public class OnMemoryDataBase {
	...
	static {
		CUSTOMER_MAP.put(1L, new Customer(1L, "Pedro Jimenez", 500, "Suspendido"));
		CUSTOMER_MAP.put(2L, new Customer(2L, "Juan Pérez", 300, "Suspendido"));
		CUSTOMER_MAP.put(3L, new Customer(3L, "Adriána López", 100, "Activo"));
		CUSTOMER_MAP.put(4L, new Customer(4L, "Melisa Martínez", 100, "Baja"));
